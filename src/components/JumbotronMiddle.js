      ...
      <Jumbotron fluid className="jumbotron-middle" id="about">
        ...
        <div className="about-text">
          <div data-aos="fade-right" data-aos-duration="2000" className="about-img">
            <Image className="diagonal-logo" fluid src={diagonalLogo} alt="diagonal logo" data-pin-media="https://squareonemission.com/resources/images/diagonal-logo.jpg" data-pin-description="Reusable Eco-Friendly Sandwich & Snack Bags" data-pin-url="https://squareonemission.com" />
            {/* <a style={{display: 'none'}} data-pin-do="buttonPin" href="https://www.pinterest.com/pin/create/button/?url=https%3A%2F%2Fwww.squareonemission.com&media=https%3A%2F%2Fsquareonemission.com%2Fresources%2Fimages%2Fdiagonal-logo.jpg&description=Reusable%20Eco-Friendly%20Sandwich%20%26%20Snack%20Bags"></a> */}
          </div>
