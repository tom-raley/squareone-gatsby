    ...
    return (
        <BackgroundImage Tag="Jumbotron" style={{ backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', width: '100vw', height: '110vh'}} className="jumbotron-top" fluid={oceanLandscape}>
          <div className="hero-text">
            ...
            <a><Button type="button" variant="primary" className="btn-square-one" id="view-products" href="https://www.amazon.com/gp/product/B07J471YWG/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=B07J471YWG&linkCode=as2&tag=squareonemiss-20&linkId=49a65b01862912ec9251d3cae5978ce7">View Our Products</Button></a>
          </div>
          </ BackgroundImage>
    )
  }
